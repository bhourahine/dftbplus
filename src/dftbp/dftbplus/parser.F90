...
#:endif
  ...
  #:endif
    ...
    #:if WITH_TRANSPORT
      call readSpinPolarisation(node, ctrl, geom, tp)
    #:else
...
#:endif
  ...
  #:endif
    ...
    case ("poisson")
      ...
      #:block REQUIRES_COMPONENT('Poisson-solver', WITH_POISSON)
        ctrl%tPoisson = .true.
        #:if WITH_TRANSPORT
          call readPoisson(value1, poisson, geom%tPeriodic, tp, geom%latVecs, ctrl%updateSccAfterDiag)
        #:else
          call readPoisson(value1, poisson, geom%tPeriodic, geom%latVecs, ctrl%updateSccAfterDiag)
        #:endif
      #:endblock
      ...
      if (associated(value1)) then
        ...
        case("onecenterapproximation")
          ...
          do iSp1 = 1, geom%nSpecies
            ...
            !call getChildValue(child2, trim(geom%speciesNames(iSp1))//":Dxx-yy|XX|Dzz",&
            ...
            !call getChildValue(child2, trim(geom%speciesNames(iSp1))//":Dxx-yy|YY|Dzz",&
  ...
  !> Spin calculation
#:if WITH_TRANSPORT
  subroutine readSpinPolarisation(node, ctrl, geom, tp)
#:else
