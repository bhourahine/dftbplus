...
module initprogram
  ...
  !> Fix the lowest eigenvalue at specified value
  logical :: tFixLowestEi

  !> set value for the bottom eigenvalue
  real(dp) :: FixLowestEi(2)              

  !> Is there a shift in the orbitals
  logical :: tOrbitalShift

  !> Values of the shifts for each spin channel
