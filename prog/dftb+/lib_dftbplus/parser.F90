  ...
  #:endif
    ...
    #:endif
      ...
      if (associated(child)) then
        ...
        call getChildValue(child, "Static", ctrl%isStaticEPerturbation, .false.)
        ...
        if (associated(child2)) then
          ...
          if (associated(child3)) then
            ...
            if (len(lr) == 3) then
              ...
              if (abs(tmp3R(2)) <= epsilon(0.0_dp)) then
        ...
        if (.not.(ctrl%isStaticEPerturbation .or. allocated(ctrl%omegaPolarisability))) then
          call detailedError(child, &
