...
contains
  ...
  subroutine getEnergyPerAtomXlbomd(this, species, orb, qOut, q0, eScc)
    ...
    call getSummedCharges(species, orb, qOut, dQ=dQOut, dQAtom=dQOutAtom, dQShell=dQOutShell, q0=q0)
  ...
  subroutine addForceDcXlbomd(this, env, species, orb, iNeighbour, img2CentCell, qOrbitalOut,&
    ...
    call getSummedCharges(species, orb, qOrbitalOut, iHubbU=this%iHubbU, dQ=dQOut,&
        & dQAtom=dQOutAtom, dQShell=dQOutLShell, dQUniqU=dQOutUniqU, q0=q0)
